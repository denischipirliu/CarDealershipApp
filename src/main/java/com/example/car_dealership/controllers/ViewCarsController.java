...
public class ViewCarsController {
        ...
        if (client == null) {
            ...
            editButton.setOnAction(actionEvent -> {
                try {
                    ...
                    editStage.getIcons().add(new Image(Objects.requireNonNull(Application.class.getResourceAsStream("icons/icon.png"))));
    ...
    public void handleAddCarButton(ActionEvent event) {
        try {
            ...
            addCarStage.getIcons().add(new Image(Objects.requireNonNull(Application.class.getResourceAsStream("icons/icon.png"))));
