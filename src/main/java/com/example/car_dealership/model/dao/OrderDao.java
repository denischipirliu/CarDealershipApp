...
import com.example.car_dealership.model.PaymentMethod;
...
public class OrderDao {
    ...
    public static final String GET_TOTAL_SALES = "SELECT SUM(price) FROM order_details INNER JOIN orders ON order_details.order_id = orders.order_id WHERE status = 'COMPLETED'";
    ...
    public float getTotalSales() {
        ...
        Connection connection = getConnection();
        try {
            PreparedStatement orderStmt = connection.prepareStatement(GET_TOTAL_SALES);
            ResultSet rs = orderStmt.executeQuery();
            while (rs.next()) {
                totalSales = rs.getFloat("sum");
